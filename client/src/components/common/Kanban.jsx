...
const Kanban = ({ sections, boardId }) => {
  ...
  const deleteSection = async (sectionId) => {
    try {
      ...
      const newData = [...data].filter((ele) => ele.id !== sectionId);
      setData(newData);
    } catch (err) {
      alert(err);
    }
  ...
  const updateSectionTitle = (e, sectionId) => {
    ...
    const newData = [...data];
    const index = newData.findIndex((ele) => ele.id === sectionId);
  ...
  const onUpdateTask = (task) => {
    const newData = [...data];
    const sectionIndex = newData.findIndex((ele) => ele.id === task.section.id);
