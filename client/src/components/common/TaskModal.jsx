...
const TaskModal = ({ selecedTask, boardId, onUpdate, onDelete, onClose }) => {
  const [task, setTask] = useState(selecedTask);
  ...
  useEffect(() => {
    setTask(selecedTask);
    setTitle(selecedTask !== undefined ? selecedTask.title : "");
    setContent(selecedTask !== undefined ? selecedTask.content : "");
    if (selecedTask !== undefined) {
      isModalClosed = false;
